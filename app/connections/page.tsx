...
export default function ConnectionsPage() {
            ...
            if (response.error) {
                ...
                wordsArray.forEach((item: string) => {
                    if (seen.has(item)) {
                        ...
                        setMessage("Duplicates found - please regenerate")
                    } else {
                        seen.add(item);
                    }
                });
    ...
    const regenerateWords = async () => {
        ...
        Generate a set of 16 words that belong to 4 different categories. (REPLICATE NYT's 'Connections', and Wordlinkle which is the same idea).
        ...
        will be the category. Be AS RANDOM AS POSSIBLE with the categories chosen, keeping in mind all other criteria.
        
        NEVER USE THE SAME WORD MORE THAN ONCE. ENSURE THEY ARE ALL ONE SINGLE WORD.
